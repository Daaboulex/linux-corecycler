...
class HistoryDB:
    ...
    def _create_schema(self) -> None:
        ...
        if cur.fetchone() is None:
            ...
            self.__conn.executescript(self._DDL_CURRENT)
            return
        ...
        if version < 6:
            ...
            version = 6
        if version < 7:
            self.__conn.executescript(self._DDL_MIGRATE_V7)
...
"""
    ...
    # Migration from v6 to v7 — add backoff tracking fields
    _DDL_MIGRATE_V7 = """\
ALTER TABLE tuner_core_states ADD COLUMN backoff_mode INTEGER NOT NULL DEFAULT 0;
ALTER TABLE tuner_core_states ADD COLUMN consecutive_backoff_fails INTEGER NOT NULL DEFAULT 0;
ALTER TABLE tuner_core_states ADD COLUMN backoff_fail_bound INTEGER;
ALTER TABLE tuner_core_states ADD COLUMN backoff_pass_bound INTEGER;
"""
